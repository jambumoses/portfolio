    ...
    <main>
      <section className="work-banner">
        ...
        <div className="dev-profile">
          <div
            data-aos="fade-up"
            // style={{
            //   backgroundImage: `url(${require(`${information.imgs.contactPage[0]}`)})`,
            // }}
      ...
      <section className="work-info-section">
        <div className="work-info-head">
          ...
          <p data-aos="fade-up">
            {/* when i'm not building or exploring new web experience, i'm probably playing games or watching football. */}
          </p>
        </div>
        <div className="work-info-2">
          ...
          <div className="work-info-2-right">
            <p data-aos="fade-up">
              ...
              individuals. ihave years of experience working and collaborating
              on product teams and leading engineering efforts.
            </p>
            <p data-aos="fade-up">
              with my experience in UI and product engineering, i solve problems
              and build appealing usable web experience.
            </p>
